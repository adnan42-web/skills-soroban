...
**38. On-Chain Randomness Frontrunning**
...
**40. Transient Storage Low-Gas Reentrancy (EIP-1153)**
...
**41. Force-Feeding ETH via selfdestruct or coinbase**
...
**42. CREATE2 Address Reuse After selfdestruct**
...
**43. extcodesize Zero / isContract Bypass in Constructor**
...
**44. Multi-Block TWAP Oracle Manipulation**
...
**45. Missing Input Validation on Critical Setters**
...
**46. Staking Reward Front-Run by New Depositor**
...
**47. ecrecover Returns address(0) on Invalid Signature**
...
**48. Griefing via Dust Deposits Resetting Timelocks or Cooldowns**
...
**49. Insufficient Gas Forwarding / 63/64 Rule Exploitation**
...
**50. Chainlink Feed Deprecation / Wrong Decimal Assumption**
...
**51. Fee-on-Transfer Token Accounting**
...
**52. Rebasing / Elastic Supply Token Accounting**
...
**53. ERC20 Non-Compliant: Return Values / Events**
...
**54. Non-Standard ERC20 Return Values (USDT-style)**
...
**56. EIP-2612 Permit Front-Run Causing DoS**
...
**57. ERC777 tokensToSend / tokensReceived Reentrancy**
...
**58. Token Decimal Mismatch in Cross-Token Arithmetic**
...
**59. Zero-Amount Transfer Revert Breaking Distribution Logic**
